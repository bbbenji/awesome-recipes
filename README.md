...
- [Tasty Cooking](https://github.com/douvy/tasty-cooking) - A modern recipe collection website optimized for performance, accessibility, and visual appeal with no clutter.
- [YunYouJun/cook](https://github.com/YunYouJun/cook) - 🍲 OK, Let's Cook! A collection of Chinese recipes.
- [Based Cooking](https://github.com/LukeSmithxyz/based.cooking) - A simple, ad-free, community-maintained recipe website with no life stories.
- [CookLikeHOC](https://github.com/Gar-b-age/CookLikeHOC) - Recipes from the Chinese fast-food chain Home Original Chicken, adapted for home cooking (Simplified Chinese).
...
- [Open Source Dough Sheeter](https://github.com/sjop/doughsheeter) - A 3D-printable dough sheeter for home bakers, based on French Guy Cooking's design.
...
- [Brewtarget](https://github.com/Brewtarget/brewtarget) - Beer recipe design software for homebrewers.
- [CocktailBerry](https://github.com/AndreWohnsland/CocktailBerry) - Software for DIY Raspberry Pi-based cocktail making machines.
- [de1app](https://github.com/decentespresso/de1app) - Open source tablet app for the Decent espresso machine, with shareable espresso profiles.
- [Gaggiuino](https://github.com/Zer0-bit/gaggiuino) - Open source mod adding pressure and temperature profiling to the Gaggia Classic espresso machine.
- [Open Drinks](https://github.com/alfg/opendrinks) - A community-driven collection of drink and cocktail recipes.
- [Salt Rim](https://github.com/karlomikus/vue-salt-rim) - Web frontend for Bar Assistant.
...
- [KitchenOwl](https://github.com/TomBursch/kitchenowl) - Self-hosted grocery list and recipe manager with meal planning and expense tracking.
...
- [OpenEats](https://github.com/open-eats/OpenEats) - Self-hosted recipe management app built with Django and React.
- [OwnRecipes](https://github.com/ownrecipes/OwnRecipes) - Self-hosted recipe management app, a fork of OpenEats.
- [PiFire](https://github.com/nebhead/PiFire) - Raspberry Pi-based smart controller for pellet smokers and grills.
- [RasPiBrew](https://github.com/steve71/RasPiBrew) - Raspberry Pi Temperature Controller for homebrewing and sous vide cooking.
- [recipe-scrapers](https://github.com/hhursev/recipe-scrapers) - Python library for scraping recipes from hundreds of cooking websites.
...
- [RecipeSage](https://github.com/julianpoy/RecipeSage) - Collaborative recipe keeper, meal planner, and shopping list organizer.
...
- [Cooklang](https://github.com/cooklang/spec) - A markup language for writing recipes as plain text.
- [cooklang-rs](https://github.com/cooklang/cooklang-rs) - Rust parser for Cooklang recipes.
